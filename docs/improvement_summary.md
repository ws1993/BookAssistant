...
**实现内容**：
- 参数名优化：spoilerPolicy → spoilerLevel
- 三个清晰级别：none（严格无剧透）、light（适度剧透）、full（完整剧透）
- 查询中明确说明每个级别的要求
- 更新测试用例
...
- 多类别警告支持（暴力、性、心理健康、歧视、虐待等）
- 适读人群标注（safeFor/cautionFor）
- 完整的渲染逻辑（彩色分级标签）
...
| 剧透控制 | 85% | 50% | 50% | 30% | **70%** ⬆️⬆️ |
| 内容警告 | 95% | 30% | 40% | 0% | **60%** ⬆️⬆️⬆️ |
